...
import { DivContainerPageLogin, DivSubContainerPageLogin } from './Login.Styled'
import { FaUserCircle } from 'react-icons/fa'
import { MdLock } from 'react-icons/md'
import { ModalShowLoading } from '../components/modal-show-loading'
...
export default function Login() {
  ...
  const [
    loginUser,
    { data: loginData, isSuccess: isLoginSuccess, isLoading },
  ...
  return (
    <>
      ...
      <ModalShowLoading Text="Iniciando sesión..." Loading={isLoading} />
    </>
  )
}
